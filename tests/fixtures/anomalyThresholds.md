...
Labeled synthetic revenue batch fixtures for regression testing anomaly detection thresholds in `src/services/revenue/anomalyDetection.ts`. These fixtures help prevent tuning changes from silently changing recall.
